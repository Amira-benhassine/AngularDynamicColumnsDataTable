...
export class VoyageSearchPanelComponent implements OnInit {
  ...
  ngOnInit() {
    this.searchFormInit();
    this.projectDeveloppementSearch.NumberOfObjectsPerPage = 3;
    this.projectDeveloppementSearch.PageNumber = 0;
...
public handlePage(e:any)
{
  ...
  this.projectDeveloppementSearch.NumberOfObjectsPerPage=this.currentPage;
  this.projectDeveloppementSearch.PageNumber=this.pageSize;
  this.getAll(this.projectDeveloppementSearch)
}
